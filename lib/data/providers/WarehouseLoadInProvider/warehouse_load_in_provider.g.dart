...
part of 'warehouse_load_in_provider.dart';
...
class _WarehouseLoadInProvider implements WarehouseLoadInProvider {
  _WarehouseLoadInProvider(
    this._dio, {
    this.baseUrl,
  }) {
    baseUrl ??= 'https://web-0x006e.cloud.okteto.net/api/warehouse/load-in';
  }
  ...
  @override
  Future<WarehouseLoadIn> getById(id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<WarehouseLoadIn> create(warehouseLoadIn) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<WarehouseLoadIn> update(warehouseLoadIn) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
